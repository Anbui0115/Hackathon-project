      ...
      <section className='bg-black flex justify-center'>
        ...
        <div className= 'flex flex-col justify-center h-auto bg-black w-[70%] tracking-wider border-none rounded-md shadow-2xl text-lightcream font-didactGothic'>
            ...
            <form onSubmit={handleSubmit} 
              action=''
              className='flex flex-col text-didactgothic justify-center align-center items-start border-cream p-8 rounded-md'>


            <label className='my-4' >
                <div className='my-5 font-bold text-l'>How Many Years of Dance Experience do you have?</div>

                <select value={danceClassId} onChange={handleChange} name='danceClassId' className='rounded-md text-black text-l p-2 border-2  shadow-2xl bg-lightcream '>
            ...
            <input value={age} name='age' onChange={handleChange} className='rounded-md mt-3 mb-1 w-[10%] bg-lightcream border-0 border-b-2 border-lightcream outline-none shadow-2xl p-2 text-black text-m'
                placeholder="Ex. 6"/>
            </label>

            <label className='mb-2 mt-4'>
                <div className='font-semibold text-l'>Where are you located? (We offer in-person and online classes)</div>
                <input value={location} name='location' onChange={handleChange} className="rounded-md mt-5 mb-2 w-[100%] text-black  font-semibold outline-none text-m border-0 border-b-2 border-lightcream shadow-2xl p-2 bg-lightcream"
