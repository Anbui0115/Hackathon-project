...
const renderDanceCards = () => {
 ...
 <div className='flex flex-col justify-center bg-black text-white w-[70%] border-none rounded-md shadow-xl p-8 m-20'>
      ...
      <form className='flex flex-col justify-center items-start'>
        ...
        <div className='py-6 flex gap-4 justify-center items-center text-lg font-semibold'>
          <button
          ...
          <button
            className="bg-teal-800 font-semibold text-white rounded-md p-2 hover:bg-teal-700 transition duration-700"
            onClick={() => router.push('/')}
          >
            Cancel
          </button>
