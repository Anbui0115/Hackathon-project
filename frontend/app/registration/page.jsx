      ...
      <section className='bg-black flex justify-center'>
        <div className= 'flex flex-col justify-center h-auto bg-inherit w-[70%] tracking-wider border-none rounded-md shadow-2xl text-lightcream font-worksans'>
            ...
            <form onSubmit={handleSubmit} 
              action=''
              className='flex flex-col justify-center align-center items-start border-4 border-cream p-8 rounded-md'>

            <label className='my-4' >
                <div className='my-5 font-semibold text-xl'>How Many Years of Dance Experience do you have?</div>

                <select value={danceClassId} onChange={handleChange} name='danceClassId' className='text-black text-xl font-semibold rounded-md p-4 border-2  shadow-2xl bg-white '>
            ...
            <input value={age} name='age' onChange={handleChange} className='mt-3 mb-1 w-[10%] text-lightcream border-0 border-b-2 border-lightcream outline-none shadow-2xl p-2 bg-inherit font-semibold'
                placeholder="Ex. 6"/>
            </label>

            <label className='mb-2 mt-4'>
                <div className='font-semibold text-xl'>Where are you located? (We offer in-person and online classes)</div>
                <input value={location} name='location' onChange={handleChange} className="mt-5 mb-2 w-[100%] text-lightcream font-semibold outline-none border-0 border-b-2 border-lightcream shadow-2xl p-2 bg-inherit"
