...
// console.log('THIS IS TESTIMONY!!!!!!!',testimony)
  return (
    <div className={`text-didactGothic bg-black bg-opacity-60 flex flex-col justify-center items-center gap-2 p-6 mx-auto w-full md:max-w-xl border-stone-300 rounded-md shadow-lg
