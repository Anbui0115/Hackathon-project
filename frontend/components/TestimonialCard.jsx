...
// console.log('THIS IS TESTIMONY!!!!!!!',testimony)
  return (
    ...
    `}>
      <div className="text-lightcream text-center text-xl md:text-lg" >"{testimony.content}"</div>
      <div className="text-center my-10">
        <div className="text-rose-200 text-xl md:text-lg text-center">{testimony.first_name}</div>
        <div className="text-rose-200 text-xl md:text-lg text-center">{testimony.last_name}</div>
