    ...
    <div onClick={(e) => e.stopPropagation()} className="z-200 fixed left-1/3 mb-40 top-1/4 bg-white text-black w-full sm:w-1/2 md:w-1/3 p-7 rounded-md shadow-lg">
      ...
      <form action="">
        ...
        <div className="py-6 flex flex-col sm:flex-row gap-4 justify-center">
          <button className="w-full sm:w-auto bg-black font-semibold text-white rounded-md p-2 transition duration-700">
            Submit
          </button>

          <button className="w-full sm:w-auto bg-black font-semibold text-white rounded-md p-2 transition duration-500 mt-2 sm:mt-0">
            Cancel
          </button>
        </div>
      </form>
