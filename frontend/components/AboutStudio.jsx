...
const AboutStudio = () => {
    return (
        <>
            <div className='z-[30] bg-black flex flex-row justify-center items-center self-center px-20 py-32 my-20'>
                ...
                <h1 className='text-2 xlmt-10 mb-10 text-cream sm:text-2xl font-elsie'>About Us</h1>
                <div className='text-l leading-relaxed  text-[#fef3c7] sm:text-lg'>
