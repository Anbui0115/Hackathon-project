...
const AboutStudio = () => {
    return (
        <>
            <div className='bg-black flex flex-row justify-center items-center self-center font-semibold px-20 py-32 my-20'>
                ...
                <h1 className='text-4xl font-bold mt-10 mb-10 text-cream sm:text-3xl capitalize'>About Us</h1>
