  ...
  return (
    <div className="bg-black text-cream h-[auto] py-4 w-full flex justify-between z-10">
        ...
        <div className="flex flex-col gap-4 items-start justify-between align-start px-10 py-6">
          <div className="flex items-center gap-4 text-cream font-semibold">
        ...
        <div className="flex flex-col px-10 py-6 gap-4 items-end">
            ...
            <nav className="text-2xl text-cream font-medium" onClick={() => setToggleModal(!toggleModal)}>
              ...
              <div className="flex gap-2">
                ...
                <div className="text-cream text-xl font-medium">Address: Priyada Arts Studio, Newark, California</div>
              </div>
        </div>
